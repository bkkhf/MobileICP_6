...
public class MainActivity extends AppCompatActivity {
    ...
    private void recognition(String text){
        ...
        if(text.contains("thank you my medical assistant")|| text.contains("thank you")){
            //speak("Thank you Bala"+preferences.getString(NAME,null)+" for using this application.");
            //System
           // editor.putString(NAME,name).apply();
            speak("Thank you "+name+" please take care");
            //speak("thank you  "+preferences.getString(NAME,"") +"please take care of your health.");
            //speak("Thank you Bala take care of your health.");
        }
